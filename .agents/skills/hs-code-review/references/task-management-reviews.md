# Review parent coordinator Management Patterns
...
**3-parent coordinator Rule:** Skip task creation when review pipeline has <3 meaningful steps. Shared hydrate/sync-back doctrine: `../../_shared/task-hydration.md`.
