# Red-Team Personas — hs:security Discovery Loop

<!-- Canonical source: hs-plan/references/red-team-personas.md — keep this self-contained copy in sync when editing personas. -->

Adapted from upstream adversarial-lens patterns by Udit Goenka (MIT).
