...
Analyze how asset works with UI elements. `Read` `docs/assets/hero-with-text-overlay.png` directly â€” this is the normal, first-class way to look at the asset, not a fallback â€” then evaluate:
...
Provide specific recommendations for adjustments. Write findings to `docs/assets/integration-analysis.md`.
