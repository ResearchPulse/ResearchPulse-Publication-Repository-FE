...
- Have `hs:codex` skill ready for texture/asset generation
...
Use `hs:codex` skill (gen-image) for:
- Textures and materials
- Skyboxes and environment maps
- Particle sprites

Video backgrounds are out of scope — no in-kit generator is provided; source video separately.
