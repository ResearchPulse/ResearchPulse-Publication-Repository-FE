...
Extract complete design system from single brand (10+ screens). `Read` each screenshot under `docs/inspiration/brand/`, then extract a complete, production-ready design system:
...
Output as CSS variables ready for implementation. Write to `docs/design-guidelines/brand-design-system.md`.

### Trend Analysis
Analyze multiple top designs to identify current trends. `Read` each screenshot under `docs/inspiration/awwwards-*`, then run a trend analysis across the award-winning designs:
...
Identify what's trending in current web design. Write to `docs/design-guidelines/trend-analysis.md`.

### Historical Evolution
Track design evolution of single brand over time. `Read` `docs/inspiration/brand-2020.png` and `docs/inspiration/brand-2024.png`, then compare:
1. What changed and why
2. What remained consistent (brand identity)
3. How trends influenced changes
4. Lessons for our design evolution

Write to `docs/design-guidelines/evolution-analysis.md`.
