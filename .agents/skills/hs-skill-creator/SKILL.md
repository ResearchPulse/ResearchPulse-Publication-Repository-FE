...
2. **Research** — Activate `/hs:docs-seeker`, `hs:research` for best practices
...
- [Agent Skills Docs](https://docs.agents.com/en/docs/claude-code/skills.md)
- [Best Practices](https://docs.agents.com/en/docs/agents-and-tools/agent-skills/best-practices.md)
