...
# Runtime-neutral kit root. The script location is identical in Claude and
# Codex installations, so no provider-specific environment is required.
HS_RUNTIME_ROOT = Path(__file__).parent.parent.parent.parent
sys.path.insert(0, str(HS_RUNTIME_ROOT / 'scripts'))
try:
