...
**parent coordinator is "available" when:** status=`pending`, no owner, blockedBy list empty.
...
**3-parent coordinator Rule:** <3 tasks → skip creation, overhead not worth it.
