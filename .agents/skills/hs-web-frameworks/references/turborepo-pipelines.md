# Turborepo parent coordinator Pipelines

parent coordinator orchestration, dependencies, and parallel execution strategies.
...
## parent coordinator Dependencies
...
## parent coordinator Configuration Options
...
## parent coordinator Execution Order
