...
- Otherwise use `hs:repomix` to generate fresh codebase summary
- Use `/hs:scout` or `/hs:scout ext` to find relevant files
- Use `hs:docs-seeker` skill for package/plugin documentation
