# Debug parent coordinator Management Patterns
...
**3-parent coordinator Rule:** Skip task creation when investigation has <3 meaningful steps.
...
## parent coordinator Schemas

### Assess parent coordinator
