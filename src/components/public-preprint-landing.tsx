      ...
      <div className="pl-container">
        ...
        {loading ? (
          ...
          <div style={{ textAlign: 'center', padding: '80px 20px', background: 'linear-gradient(180deg, #f8fafc 0%, #f1f5f9 100%)', borderRadius: 24, border: '1px dashed #cbd5e1', boxShadow: 'inset 0 2px 4px rgba(0,0,0,0.02)' }}>
            ...
            <a href="#register-section" onClick={scrollToRegister} className="pl-published-btn-primary">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><line x1="12" y1="5" x2="12" y2="19"></line><line x1="5" y1="12" x2="19" y2="12"></line></svg>
              <span>Khởi Tạo Hồ Sơ &amp; Nộp Công Trình</span>
            </a>
          </div>
        ) : (
          <>
            {displayItems.length === 0 ? (
              ...
              <>
                ...
                <div style={{ textAlign: 'center', marginTop: 44 }}>
                  <a href="#register-section" onClick={scrollToRegister} className="pl-published-btn-primary">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><line x1="12" y1="5" x2="12" y2="19"></line><line x1="5" y1="12" x2="19" y2="12"></line></svg>
                    <span>Khởi Tạo Hồ Sơ &amp; Nộp Công Trình Của Bạn</span>
                  </a>
                </div>
              </>
            )}
      ...
      {mounted && selected && createPortal(
        ...
        >
          ...
          >
            ...
            <div className="pl-published-modal-actions">
              {modalTab === 'pdf' ? (
                <>
                  <button type="button" onClick={() => setModalTab('overview')} className="pl-published-btn-secondary" style={{ display: 'inline-flex', alignItems: 'center', gap: 6, whiteSpace: 'nowrap' }}>
                    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><polyline points="15 18 9 12 15 6" /></svg>
                    Quay Lại Tóm Tắt
                  </button>
                  <button type="button" onClick={() => setSelected(null)} className="pl-published-btn-secondary" style={{ whiteSpace: 'nowrap' }}>Đóng</button>
                </>
              ) : (
                <>
                  <button type="button" onClick={() => setSelected(null)} className="pl-published-btn-secondary" style={{ whiteSpace: 'nowrap' }}>Đóng</button>
                  <button
                    ...
                    style={{ display: 'inline-flex', alignItems: 'center', gap: 6, textDecoration: 'none', cursor: 'pointer', whiteSpace: 'nowrap' }}
                  >
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line><polyline points="10 9 9 9 8 9"></polyline></svg>
                    <span>Xem Chi Tiết Bài Báo (PDF)</span>
                  </button>
                </>
              )}
            </div>
