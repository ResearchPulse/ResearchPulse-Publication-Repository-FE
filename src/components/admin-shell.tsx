  ...
  return <aside className="admin-sidebar">
    ...
    <div>
      ...
      <nav className="side-nav" aria-label="Admin navigation">
        <Link href="/dashboard" aria-current={active === 'dashboard' ? 'page' : undefined}><span className="nav-icon">01</span><span>Dashboard</span></Link>
        <Link href="/submissions" aria-current={active === 'submissions' ? 'page' : undefined}><span className="nav-icon">02</span><span>Submissions</span></Link>
        <Link href="/reviews" aria-current={active === 'reviews' ? 'page' : undefined}><span className="nav-icon">03</span><span>Reviews</span></Link>
      </nav>
    </div>
